...
| Calendar | ID | Purpose |
|---|---|---|
| Work | `richard@nilsark.com` | Client meetings, work, NILSARK CONSULTING |
| Family | `richard.nilsark@gmail.com` | Family and private commitments (shared into the work account with edit rights) |
...
- Calendar access goes through the `gws` CLI in Bash (`gws calendar ...`). Auth is already done
  as `richard@nilsark.com`; the family calendar is reached through the share, using its ID as `calendarId`.
